  ...
  return (
    <div className="home-container">
      ...
      <section id="our-story" className="our-story">
        <h2>Our Story</h2>
        <p>
          Welcome to Outdoor Leisure! We started with a simple goal: to provide top-quality spas, swim spas, and gazebos to enhance your outdoor living experience. Our products are carefully selected for their durability, aesthetics, and comfort, ensuring that you enjoy relaxation and luxury in your own backyard.
        </p>
        <p>
